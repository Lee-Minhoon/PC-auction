...
<section class="index">
	...
	<section class="auctionList">
		...
		<div>
			...
			$query = "SELECT * FROM auction WHERE bid_state = '거래종료'";
			...
			$query = "SELECT * FROM auction WHERE bid_state = '거래종료' ORDER BY auction_num DESC LIMIT $start_point, $list"; //첫번째 게시글부터 한페이지에 보여줄 게시글 갯수만큼 들고옴
			$result = mysqli_query($conn, $query);
